            ...
            <div className="bg-white p-3 rounded w-25">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        ...
                        <input type="text" placeholder='Felhasználónév'name='name' className='form-control rounded-0' onChange={e => setValues({...values, name: e.target.value})}/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="email"><strong>Email</strong></label>
                        <input type="email" placeholder='Email'name='email' className='form-control rounded-0' onChange={e => setValues({...values, email: e.target.value})}/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="password"><strong>Jelszó</strong></label>
                        <input type="password" placeholder='Jelszó'name='password' className='form-control rounded-0' onChange={e => setValues({...values, password: e.target.value})}/>
                    </div>
